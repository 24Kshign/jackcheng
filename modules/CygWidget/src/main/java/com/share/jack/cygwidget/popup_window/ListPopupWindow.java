...
public class ListPopupWindow extends BasePopupWindow {
    ...
    private ListPopupWindow(Activity context) {
        super(context);
    }
    private ListPopupWindow(Activity context, Builder builder){
        this(context);
    ...
    public static class Builder{
        ...
        public ListPopupWindow build(){
            return new ListPopupWindow(mContext,this);
        }
    ...
    class ListPopupAdapter extends BaseAdapter{
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView==null){
                vh=new ViewHolder();
                convertView=mInflater.inflate(R.layout.pw_list_item,parent,false);
    ...
    public View getPopupView() {
        return getPopupViewById(R.layout.pw_list_popupwindow);
    }
