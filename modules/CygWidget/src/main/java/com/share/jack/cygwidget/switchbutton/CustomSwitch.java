package com.share.jack.cygwidget.switchbutton;
...
public class CustomSwitch extends View implements ValueAnimator.AnimatorUpdateListener, ValueAnimator.AnimatorListener {
    ...
    private int mOnBackgroundColor = 0xff09bb07;
    ...
    private long mOnAnimationDuration = 300L;
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (onCheckedChangeListener != null) {
                    onCheckedChangeListener.onCheckedChanged(this, mIsOpen);
                }
                return true;
        }
    ...
    public interface OnCheckedChangeListener {
        void onCheckedChanged(CustomSwitch customSwitch, boolean checked);
    }
}
