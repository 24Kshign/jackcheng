...
//        }
        ...
        titleBar.setBackgroundColor(ContextCompat.getColor(getActivity(),R.color.color_main));
        Bundle bundle = getArguments();
        titleBar.setTitle(bundle.getString(ChatActivity.EXTRA_USER_NICK));
...
//        RzEventBus.post(new EaseMobOnConversationInitEvent());
    }
}
